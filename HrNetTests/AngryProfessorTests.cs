...
namespace HrNet.Tests
{
    ...
    public class AngryProfessorTests
    {
        ...
        //    string res = angryProfessor.angryProfessor(3, new int[] { -2, -1, 0, 1, 2 });
        ...
        {
            AngryProfessor angryProfessor = new AngryProfessor();
            string res = angryProfessor.angryProfessor(3, new int[] { -1, -3, 4, 2 });
            Assert.IsTrue(res == "YES");
        }

        [TestMethod()]
        public void angryProfessorTest3()
        {
            AngryProfessor angryProfessor = new AngryProfessor();
            string res = angryProfessor.angryProfessor(2, new int[] { 0, -1, 2, 1});
            Assert.IsTrue(res == "NO");
        }

        [TestMethod()]
        public void angryProfessorTest4()
        {
            AngryProfessor angryProfessor = new AngryProfessor();
            string res = angryProfessor.angryProfessor(4, new int[] { -93, -86, 49, -62, -90, -63, 40, 72, 11, 67 });
            Assert.IsTrue(res == "NO");
        }

        [TestMethod()]
        public void angryProfessorTest5()
        {
            AngryProfessor angryProfessor = new AngryProfessor();
            string res = angryProfessor.angryProfessor(10, new int[] { 23,- 35,- 2, 58, -67, -56, -42, -73, -19, 37 });
            Assert.IsTrue(res == "YES");
        }
    }
}
